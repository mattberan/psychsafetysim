...
export function ScenarioScreen() {
  const { currentScenario, selectChoice, currentIndex, scenarioQueue } = useGameStore()
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ fontSize: '12px', fontWeight: 600, color: catColor, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          ...
          <div style={{ display: 'flex', gap: '4px' }}>
            {Array.from({ length: total }).map((_, i) => (
              <div key={i} style={{
                ...
                borderRadius: '2px',
                background: i < currentIndex ? 'var(--amber)' : i === currentIndex ? 'var(--amber)' : 'var(--surface2)',
      ...
      <div style={{
        ...
        {/* Character message — the BIG moment */}
        <AnimatePresence>
          {contextVisible && (
            <motion.div
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>
                    {currentScenario.characterRole}
                  </div>
                </div>
              </div>

              {/* The trigger — large and prominent */}
              <div style={{
